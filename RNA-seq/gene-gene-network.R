...
### gene-gene network. expression(DEG) = expression(POE) + sex 
ggi_e27 = function(zz1, fdr1){
  ...
  ase = fread(paste0("/data_group/xiehaibing/xiehaibing2/f1/rna/pysam/expression/deg/", 
                     zz1, "_poe_read10_sig.txt"))
  g1 = deg$geneID
  g2 = ase$geneID
